...
@GenerateNiceMocks([MockSpec<IArticlesRepository>()])
final _fakeArticles = [
  ArticleModel(
    title: 'article 1',
    abstract: 'abstract 1',
...
void main() {
  ...
  late MockIArticlesRepository repository;

  setUp(() {
    repository = MockIArticlesRepository();

    when(
      repository.getArticles(),
    ).thenAnswer(
      (_) async => _fakeArticles,
    );
